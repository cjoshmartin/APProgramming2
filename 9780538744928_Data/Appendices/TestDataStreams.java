/* Example H1: TestDataStreams.java
1) Write randomly generated integers to a data output stream. A command 
line parameter specifies the number of integers to generate. 
...
public class TestDataStreams{
   ...
   public static void main (String[] args){
      ...
      try{
         ...
         int i;
         for (i = 0; i < number; i++)
            doStream.writeInt(gen.nextInt(number + 1));
         doStream.close();
      }catch(IOException e){
