...
public class LuckySevens {
	...
	private int dollars, maxd, counterols, highmoney;
	
	public LuckySevens(int a) {
		dollars = a;
		roll();
	}
	...
	public void roll(){
		...
		maxd = maxDollars; counterols = count; highmoney = countAtMax;
	}
	public String toString()
	{
		return "You are broke after " + counterols + " rolls.\n" + "You should have quit after " + highmoney + " rolls when you had $" + maxd + ".";
	}
